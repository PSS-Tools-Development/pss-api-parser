...
if __name__ == '__main__':
    ...
    parser.add_argument('--in', dest='in_', nargs='+', type=str, required=True, help='The file to be parsed')
    ...
    with _Timer() as t:
        ...
        if args.function == 'flows':
            ...
            for in_file in args.in_:
                ...
                output_file_name = f'{_os.path.splitext(input_file_name_with_extension)[0]}.json'
