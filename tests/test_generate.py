...
def test___get_return_type__multiple_entity_collections():
    ...
    expected_result = ('ListUsers', [('Message', 'Messages', True), ('User', 'Users', True)])
...
def test___get_return_type__multiple_entity_types():
    ...
    expected_result = ('InspectShip', [('Ship', 'InspectShip', False), ('User', 'InspectShip', False)])
...
def test___get_return_type__multiple_entity_types_and_collections():
    ...
    entity_names = ['Alliance', 'Character', 'Item', 'Lift', 'Research', 'Ship', 'ShipDesign', 'User', 'UserStarSystem']
    expected_result = ('DummyEndpoint', [('Ship', 'DummyEndpoint', False), ('User', 'Users', True)])
...
def __return_type_tuples_equal(d1: _Tuple[str, _List[_Tuple[str, str, bool]]], d2: _Tuple[str, _List[_Tuple[str, str, bool]]]) -> bool:
